...
HXLINE(  85)		::hxvlc::util::Handle_obj::initWithRetry(::Array_obj< ::String >::fromData( _hx_array_data_332f6459_9,1),false);
HXLINE(  89)		{
...
HXLINE( 181)		::flixel::FlxG_obj::keys->preventDefaultKeys = ::Array_obj< int >::fromData( _hx_array_data_332f6459_10,1);
