...
HXLINE(  80)		{
HXLINE(  80)			::String v = (::ManifestResources_obj::rootPath + HX_("manifest/libvlc.json",6e,60,b6,a2));
HXDLIN(  80)			::lime::utils::Assets_obj::libraryPaths->set(HX_("libvlc",48,b2,be,e4),v);
            		}
HXLINE(  81)		{
HXLINE(  81)			::String v1 = (::ManifestResources_obj::rootPath + HX_("manifest/default.json",95,ea,cc,42));
HXDLIN(  81)			::lime::utils::Assets_obj::libraryPaths->set(HX_("default",c1,d8,c3,9b),v1);
            		}
