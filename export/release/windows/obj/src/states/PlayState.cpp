...
HX_LOCAL_STACK_FRAME(_hx_pos_801e532e222627de_855_startVideo,"states.PlayState","startVideo",0x8b5680d6,"states.PlayState.startVideo","states/PlayState.hx",855,0x36e487ae)
...
HXLINE( 682)		bool _hx_tmp1;
HXDLIN( 682)		if (::hx::IsNotNull( this->videoCutscene )) {
HXLINE( 682)			_hx_tmp1 = ::hx::IsNotNull( this->videoCutscene->videoSprite );
            		}
            		else {
HXLINE( 682)			_hx_tmp1 = false;
            		}
HXDLIN( 682)		if (_hx_tmp1) {
HXLINE( 682)			this->videoCutscene->videoSprite->bitmap->set_rate(( (float)(value) ));
            		}
...
HX_DEFINE_DYNAMIC_FUNC2(PlayState_obj,startCharacterPos,(void))
 ...
 ::objects::VideoSprite PlayState_obj::startVideo(::String name,::hx::Null< bool >  __o_forMidSong,::hx::Null< bool >  __o_canSkip,::hx::Null< bool >  __o_loop,::hx::Null< bool >  __o_playOnLoad){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_801e532e222627de_831_startVideo)
HXDLIN( 831)		 ::states::PlayState _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 833)		this->inCutscene = !(forMidSong);
HXLINE( 834)		this->canPause = forMidSong;
HXLINE( 836)		bool foundFile = false;
HXLINE( 837)		::String fileName = ::backend::Paths_obj::video(name);
HXLINE( 840)		if (::sys::FileSystem_obj::exists(fileName)) {
HXLINE( 844)			foundFile = true;
            		}
HXLINE( 846)		if (foundFile) {
HXLINE( 848)			this->videoCutscene =  ::objects::VideoSprite_obj::__alloc( HX_CTX ,fileName,forMidSong,canSkip,loop);
HXLINE( 849)			if (forMidSong) {
HXLINE( 849)				this->videoCutscene->videoSprite->bitmap->set_rate(( (float)(this->playbackRate) ));
            			}
HXLINE( 852)			if (!(forMidSong)) {
            				HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::states::PlayState,_gthis) HXARGC(0)
            				void _hx_run(){
            					HX_GC_STACKFRAME(&_hx_pos_801e532e222627de_855_startVideo)
HXLINE( 856)					bool onVideoEnd;
HXDLIN( 856)					bool onVideoEnd1;
HXDLIN( 856)					bool onVideoEnd2;
HXDLIN( 856)					bool onVideoEnd3;
HXDLIN( 856)					if (!(_gthis->isDead)) {
HXLINE( 856)						onVideoEnd3 = _gthis->generatedMusic;
            					}
            					else {
HXLINE( 856)						onVideoEnd3 = false;
            					}
HXDLIN( 856)					if (onVideoEnd3) {
HXLINE( 856)						onVideoEnd2 = ::hx::IsNotNull(  ::Dynamic(::states::PlayState_obj::SONG->__Field(HX_("notes",41,dc,ca,9f),::hx::paccDynamic))->__GetItem(::Std_obj::_hx_int((( (Float)(_gthis->curStep) ) / ( (Float)(16) )))) );
            					}
            					else {
HXLINE( 856)						onVideoEnd2 = false;
            					}
HXDLIN( 856)					if (onVideoEnd2) {
HXLINE( 856)						onVideoEnd1 = !(_gthis->endingSong);
            					}
            					else {
HXLINE( 856)						onVideoEnd1 = false;
            					}
HXDLIN( 856)					if (onVideoEnd1) {
HXLINE( 856)						onVideoEnd = !(_gthis->isCameraOnForcedPos);
            					}
            					else {
HXLINE( 856)						onVideoEnd = false;
            					}
HXDLIN( 856)					if (onVideoEnd) {
HXLINE( 858)						_gthis->moveCameraSection(null());
HXLINE( 859)						::flixel::FlxG_obj::camera->snapToTarget();
            					}
HXLINE( 861)					_gthis->videoCutscene = null();
HXLINE( 862)					_gthis->canPause = true;
HXLINE( 863)					_gthis->inCutscene = false;
HXLINE( 864)					_gthis->startAndEnd();
            				}
            				HX_END_LOCAL_FUNC0((void))

HXLINE( 854)				 ::Dynamic onVideoEnd =  ::Dynamic(new _hx_Closure_0(_gthis));
HXLINE( 866)				this->videoCutscene->finishCallback = onVideoEnd;
HXLINE( 867)				this->videoCutscene->onSkip = onVideoEnd;
            			}
HXLINE( 869)			bool _hx_tmp;
HXDLIN( 869)			if (::hx::IsNotNull( ::substates::GameOverSubstate_obj::instance )) {
HXLINE( 869)				_hx_tmp = this->isDead;
            			}
            			else {
HXLINE( 869)				_hx_tmp = false;
            			}
HXDLIN( 869)			if (_hx_tmp) {
HXLINE( 869)				::substates::GameOverSubstate_obj::instance->add(this->videoCutscene).StaticCast<  ::flixel::FlxBasic >();
            			}
            			else {
HXLINE( 870)				this->add(this->videoCutscene);
            			}
HXLINE( 872)			if (playOnLoad) {
HXLINE( 873)				this->videoCutscene->play();
            			}
HXLINE( 874)			return this->videoCutscene;
            		}
            		else {
HXLINE( 877)			this->addTextToDebug((HX_("Video not found: ",16,86,55,3d) + fileName),-65536);
            		}
...
HXDLIN( 941)			goto _hx_goto_45;
            		}
            		if (  (_hx_switch_0==HX_("pixel",86,c6,a3,c2)) ){
HXLINE( 941)			introImagesArray = ::Array_obj< ::String >::fromData( _hx_array_data_0420cd31_49,3);
HXDLIN( 941)			goto _hx_goto_45;
            		}
            		/* default */{
...
HXDLIN(1005)					goto _hx_goto_52;
            				}
            				if (  (_hx_switch_0==HX_("pixel",86,c6,a3,c2)) ){
HXLINE(1005)					introImagesArray = ::Array_obj< ::String >::fromData( _hx_array_data_0420cd31_57,3);
HXDLIN(1005)					goto _hx_goto_52;
            				}
            				/* default */{
...
HXLINE( 987)			::Array< int > swagCounter = ::Array_obj< int >::fromData( _hx_array_data_0420cd31_62,1);
...
HXLINE(1996)				if (::hx::IsNotNull( this->videoCutscene )) {
HXLINE(1998)					this->videoCutscene->destroy();
HXLINE(1999)					this->videoCutscene = null();
            				}
...
HXDLIN(2151)				goto _hx_goto_136;
            			}
            			if (  (_hx_switch_1==HX_("gf",1f,5a,00,00)) ||  (_hx_switch_1==HX_("girlfriend",ba,91,48,98)) ){
HXLINE(2149)				_hx_char = this->gf;
HXDLIN(2149)				goto _hx_goto_136;
            			}
            			/* default */{
...
HXLINE(2860)				this->checkForAchievement(::Array_obj< ::String >::fromData( _hx_array_data_0420cd31_174,1));
            			}
            		}
...
HXLINE(3176)		if (::hx::IsNotNull( this->videoCutscene )) {
HXLINE(3178)			this->videoCutscene->destroy();
HXLINE(3179)			this->videoCutscene = null();
            		}
