...
class HXCPP_CLASS_ATTRIBUTES MenuItem_obj : public  ::flixel::FlxSprite_obj
{
	...
	public:
		...
		void __construct(Float x,Float y,::String __o_weekName, ::Dynamic onCreate);
		...
		static ::hx::ObjectPtr< MenuItem_obj > __new(Float x,Float y,::String __o_weekName, ::Dynamic onCreate);
		static ::hx::ObjectPtr< MenuItem_obj > __alloc(::hx::Ctx *_hx_ctx,Float x,Float y,::String __o_weekName, ::Dynamic onCreate);
